  ...
  return (
    <div className="px-5 pt-[5vw] rounded-md border shadow md:min-w-[450px] bg-white h-full flex flex-col items-center gap-10 pb-10">
      ...
      <div className="flex items-center flex-row">
        ...
        <h1 className='text-[30px] font-bold -ml-8 '>Sign-Up {'>w>'}</h1>
      </div>

      <form onSubmit={signUp} className="w-full flex gap-5 flex-col">
        <input
        ...
        <Link href="/auth/signin" className="underline text-[15px] font-nano text-gray-500 cursor-pointer mt-5" > Have no account? </Link>
